...
- `index.html` – root HTML shell (mounts `#app`)
- `src/main.js` – JavaScript entry that renders the landing layout and basic button interactions
- `src/main.scss` – SCSS entry file imported from `main.js`
